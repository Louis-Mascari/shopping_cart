            ...
            React.createElement('div', {
                ...
                children: [
                    ...
                    React.createElement('button', {
                        className: "checkout",
                        disabled: true}, "Checkout")
                ] 
            })
        ]}),
        React.createElement('main', {children: [
            React.createElement('div', {className: "product-listing", children: [
                React.createElement('h2', null, 'Products'),
                React.createElement('ul', {className: 'product-list', children: [
                    React.createElement('li', {className: "product", children: [
                        React.createElement('div', {className: 'product-details', children: [
                            React.createElement('h3', null, 'Amazon Kindle E-Reader'),
                            React.createElement('p', {className: 'price'}, "$79.99"),
                            React.createElement('p', {className: 'quantity'}, "5 left in stock"),
